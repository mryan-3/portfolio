...
const Blog: React.FC = () => {
    return (
        <div className='font-titillium h-full text-white max-w-xl mx-auto p-4 mb-4'>
            ...
            <div className="my-4 flex-col justify-between">
                <div className="flex justify-between gap-2">
                    <div className="w-[30%]">
                        <p className="text-[14px] text-center">Dec 20 2023</p>
                    ...
                    <div className="flex flex-col">
                        ...
                        <a className="font-semibold">Lightining Fast APIs: Building Golang CRUD Endpoints with Supabase </a>
                    </div>
                </div>
