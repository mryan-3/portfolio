      ...
      <div className='my-4 flex-col'>
        <div className='flex gap-6 my-4'>
          ...
          <div className='flex flex-col w-[50%] md:w-[70%]'>
            ...
            <a
              ...
              href='https://ryanm.hashnode.dev/lightning-fast-apis-building-golang-crud-endpoints-with-supabase'
              target='_blank'
              rel='noopener'
            >
              Lightning Fast APIs: Building Golang CRUD Endpoints with
              Supabase⚡️
            </a>
          </div>
        </div>
        ...
        <div className='flex gap-6 my-4'>
          ...
          <div className='flex flex-col w-[50%] md:w-[70%]'>
            ...
            <a
              className='font-semibold text-[14px]'
              href='https://ryanm.hashnode.dev/building-a-restful-api-with-supabase-nodejs-and-expressjs-a-comprehensive-guide'
              target='_blank'
              rel='noopener'
            >
              Building a RESTful API with Supabase, Node.js, and Express.js: A
              Comprehensive Guide
            </a>
          </div>
        </div>
        ...
        <div className='flex gap-6 my-4'>
          ...
          <div className='flex flex-col w-[50%] md:w-[70%]'>
            ...
            <a
              className='font-semibold text-[14px]'
              href='hashnode.com/post/clync87c4000009lc0sf38vcm'
              target='_blank'
              rel='noopener'
            >
              Designing APIs using the OpenAPI Specification
            </a>
          </div>
        </div>
        ...
        <div className='flex gap-6 my-4'>
          ...
          <div className='flex flex-col w-[50%] md:w-[70%]'>
            ...
            <a
              className='font-semibold text-[14px]'
              href='https://hashnode.com/post/clyfk4isj001f09i8gjfw5xl6'
              target='_blank'
              rel='noopener'
            >
              How to Fix 'ERROR: prepared statement 'S_1' already exists' in
              Supabase, PostgreSQL, Go, and GORM
            </a>
          </div>
        </div>
      </div>
